...
\textbf{Skill Extraction Agent.} This component uses spaCy's small English model together with noun-phrase and entity heuristics to extract candidate skills. Skills from the skills section are treated as explicit skills, while skills inferred from experience and project text are treated as implicit skills.
...
\section*{AI Tool Credit}

The team used Codex App, Visual Studio Code, and Codex 5.5 as development support tools for code editing, debugging, documentation cleanup, and report revision. The authors reviewed the generated suggestions, ran the project tests and pipeline checks, and are responsible for the final implementation, results, and written submission.

\section*{Presentation Recording}

The final project presentation recording is available at:
\url{https://asu.zoom.us/rec/share/aPQ2p2a4qUETTp2Xl8vtixpE77IRjuzYqhbKioS-P1fS-zt7LIbIRNGSw5b76rFm.km_N5WnZANClW4Gi?startTime=1777592720000}

Recording passcode: \texttt{=0\&*h\$Cr}
